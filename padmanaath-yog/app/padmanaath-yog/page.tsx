          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="sanatan-card">
              ...
              <p className="text-muted-foreground">
                ...
                beauty that enhances the yoga experience.
              </p>
            </div>
      ...
      <section className="container mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="sanatan-card">
            ...
            <p className="text-muted-foreground">
              During rainy days, doing yoga with pouring rain is an experience
      ...
      <section className="bg-yoga-cream py-16 rounded-2xl">
        <div className="container max-w-4xl text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-muted-foreground">
            ...
            unique approach to yoga and wellness. Address the root causes of
