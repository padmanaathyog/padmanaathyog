    ...
    <>
      ...
      <div className="container relative z-10 px-4 py-20">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-4 text-muted-foreground">
            Yog saadhana is as ancient as Indus civilisation. It draws
            its roots from:
          </p>
          <ul className="staggered-container pl-4">
            ...
            <li className="staggered-item text-muted-foreground">
            Patanjali yog sutra, Gheranda Samhita, and Hatha yog
            pradipika
            </li>
          </ul>
          </div>
          <p className="text-lg mb-8 text-muted-foreground">
          As per Shiva Samhita, Lord Shiva is the originator of yog. It
          traces its lineage through pre-vedic, vedic, classical, post
          classical to present period. Swami Vivekananda was instrumental
          in introducing yog to the global mass.
          </p>
      ...
      <div className="container">
        ...
        <div className="mb-8 text-center">
          ...
          teachings of Yog in its current form.
          </p>
      ...
      <div className="container">
        ...
        <div className="sanatan-border mb-8">
          ...
          <p className="mb-6 text-muted-foreground">
          Basic canvas is Ashthanga yog of Rishi Patanjali, Hatha yog
          ...
          <div>
            ...
            As pranayama is an essential integral part of yog protocol,
      ...
      <div className="container max-w-4xl text-center">
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto text-muted-foreground">
          ...
          authentic yog practices rooted in ancient wisdom.
        </p>
